        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <div className="flex items-center space-x-6 text-stadtkueken-brown">
              <a href="tel:04032890120" className="flex items-center space-x-2 hover:text-stadtkueken-orange transition-colors">
              ...
              <a href="mailto:info@stadtkueken.de" className="flex items-center space-x-2 hover:text-stadtkueken-orange transition-colors">
